...
class Layout:
    ...
    def __create_layout(self)->list['list[sg.Element]']:
        ...
        right_frame_content = [
            ...
            [sg.VStretch()],
            [sg.Slider(range=(0, 1), orientation='h', resolution=.1, default_value=self.DEFAULT_PRECISION_VALUE, enable_events=True, size=(15, 15), key=self.KEY_PRECISSION_SLIDER)],
